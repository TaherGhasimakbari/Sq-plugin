...
#include "RingBuffer.h"  // member
#include "DArray.h"      // member
...
namespace Util
{
   ...
   */
   ...
   public:
      ...
      *
      * The default parameter values are the same as those set in the
      * constructor.
      *
      ...
      */
      void setParam(int bufferCapacity=64, int maxStageId=10, 
                    int blockFactor=2);
